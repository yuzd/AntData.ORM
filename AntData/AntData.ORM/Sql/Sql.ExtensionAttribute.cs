...
namespace AntData.ORM
{
    ...
    public partial class Sql
    {
        ...
        public class ExtensionAttribute : ExpressionAttribute
        {
            ...
            public static string ResolveExpressionValues([JetBrains.Annotations.NotNull] string expression, [JetBrains.Annotations.NotNull] Func<string, string, string> valueProvider)
            {

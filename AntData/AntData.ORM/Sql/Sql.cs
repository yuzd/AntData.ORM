...
namespace AntData.ORM
{
	...
	public static partial class Sql
	{
        ...
        [AntData.ORM.Sql.DatePartAttribute(PN.Oracle, "Add{0}", false, 0, 2, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.DB2, "{{1}} + {0}", Precedence.Additive, true, new[] { "{0} Year", "({0} * 3) Month", "{0} Month", "{0} Day", "{0} Day", "({0} * 7) Day", "{0} Day", "{0} Hour", "{0} Minute", "{0} Second", "({0} * 1000) Microsecond" }, 0, 1, 2)]
        [AntData.ORM.Sql.DatePartAttribute(PN.Informix, "{{1}} + Interval({0}", Precedence.Additive, true, new[] { "{0}) Year to Year", "{0}) Month to Month * 3", "{0}) Month to Month", "{0}) Day to Day", "{0}) Day to Day", "{0}) Day to Day * 7", "{0}) Day to Day", "{0}) Hour to Hour", "{0}) Minute to Minute", "{0}) Second to Second", null }, 0, 1, 2)]
        [AntData.ORM.Sql.DatePartAttribute(PN.PostgreSQL, "{{1}} + {{0}} * Interval '1 {0}", Precedence.Additive, true, new[] { "Year'", "Month' * 3", "Month'", "Day'", "Day'", "Day' * 7", "Day'", "Hour'", "Minute'", "Second'", "Millisecond'" }, 0, 1, 2)]
        [AntData.ORM.Sql.DatePartAttribute(PN.MySql, "Date_Add({{1}}, Interval {{0}} {0})", true, new[] { null, null, null, "Day", null, null, "Day", null, null, null, null }, 0, 1, 2)]
        [AntData.ORM.Sql.DatePartAttribute(PN.SQLite, "DateTime({{1}}, '{{0}} {0}')", true, new[] { null, null, null, "Day", null, null, "Day", null, null, null, null }, 0, 1, 2)]
        [AntData.ORM.Sql.DatePartAttribute(PN.Access, "DateAdd({0}, {{0}}, {{1}})", true, new[] { "'yyyy'", "'q'", "'m'", "'y'", "'d'", "'ww'", "'w'", "'h'", "'n'", "'s'", null }, 0, 1, 2)]
        [AntData.ORM.Sql.DatePartAttribute(PN.SapHana, "Add_{0}", true, new[] { "Years({1}, {0})", "Months({1}, {0} * 3)", "Months({1}, {0})", "Days({1}, {0})", "Days({1}, {0})", "Days({1}, {0} * 7)", "Days({1}, {0})", "Seconds({1}, {0} * 3600)", "Seconds({1}, {0} * 60)", "Seconds({1}, {0})", null }, 0, 1, 2)]
		...
		[CLSCompliant(false)]
		[Sql.Function]
		[AntData.ORM.Sql.DatePartAttribute(PN.DB2,        "{0}",                               false, new[] { null,     null,  null,   null,      null,   null,  "DayOfWeek", null,     null,   null,   null   }, 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.Informix, "{0}", 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.MySql, "Extract({0} from {{0}})", true, 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.PostgreSQL, "Extract({0} from {{0}})", true, new[] { null, null, null, "DOY", null, null, "DOW", null, null, null, null }, 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.Firebird, "Extract({0} from {{0}})", true, new[] { null, null, null, "YearDay", null, null, null, null, null, null, null }, 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.Oracle, "To_Number(To_Char({{0}}, {0}))", true, new[] { "'YYYY'", "'Q'", "'MM'", "'DDD'", "'DD'", "'WW'", "'D'", "'HH24'", "'MI'", "'SS'", "'FF'" }, 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.SQLite, "Cast(StrFTime({0}, {{0}}) as int)", true, new[] { "'%Y'", null, "'%m'", "'%j'", "'%d'", "'%W'", "'%w'", "'%H'", "'%M'", "'%S'", "'%f'" }, 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.Access, "DatePart({0}, {{0}})", true, new[] { "'yyyy'", "'q'", "'m'", "'y'", "'d'", "'ww'", "'w'", "'h'", "'n'", "'s'", null }, 0, 1)]
        [AntData.ORM.Sql.DatePartAttribute(PN.SapHana, "{0}", true, new[] { "Year({0})", "Floor((Month({0})-1) / 3) + 1", "Month({0})", "DayOfYear({0})", "DayOfMonth({0})", "Week({0})", "MOD(Weekday({0}) + 1, 7) + 1", "Hour({0})", "Minute({0})", "Second({0})", null }, 0, 1)]
        ...
        [AntData.ORM.Sql.DatePartAttribute(PN.SapHana, "{0}", true, new[] { null, null, null, null, "Days_Between({0}, {1})", null, null, "Seconds_Between({0}, {1}) / 3600", "Seconds_Between({0}, {1}) / 60", "Seconds_Between({0}, {1})", "Nano100_Between({0}, {1}) / 10000" }, 0, 1, 2)]
